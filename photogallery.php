            ...
            <div class="menu">
                <div class="menu-bar-container">
                    <div class="menu-bar-content">
                        ...
                        <div class="menu-info" ><a href=""><i class="fa fa-camera" aria-hidden="true"></i>Photo</a></div>
            ...
            <div class="gallery" id="">
                <div class="photo">
                    ...
                    <div class="photo-upload">
                        <form action="" method="POST" enctype="multipart/form-data">
                            <input type="file" name="photo" id="file_upload" style="display: none;"><br>
                            <label for="file_upload" class="photo-filter"> Add photo</label>
                ...
                <div class="gellery-container">
                    <div class="gellery-info ">
                        <div></div>
                        <div class="img-1 ">
                            <a href="img/girls1.jpg"> <img src="img/girls1.jpg" alt=""></a>                          
                        </div>
                        <div class="img-1 ">                           
                            <a href="img/boy5.jpg"> <img src="img/boy5.jpg" alt=""></a>                          
                        </div>
                        <div class="img-1 ">
                            <a href="img/boy2.jpg"> <img src="img/boy2.jpg" alt=""></a>
                        </div>
                        <div class="img-1 ">                           
                            <a href="img/boy4.jpg"> <img src="img/boy4.jpg" alt=""></a>                         
                        </div>
                        <div class="img-1 ">                           
                            <a href="img/girl3.jpg"> <img src="img/girl3.jpg" alt=""></a>                        
                        </div>
                        <div class="img-1 ">                           
                            <a href="img/girl3.jpg"> <img src="img/girl3.jpg" alt=""></a>                        
                        </div>
